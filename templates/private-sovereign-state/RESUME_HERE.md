...
This is a private, person-owned continuity repository. It helps a GPT recover what matters without asking the owner to start over.

It is one part of the person's human–AI operating configuration. It is not the person, the complete relationship, or an autonomous authority.
...
- Trusted helper role: None recorded
- Last reviewed: Not yet reviewed

## How to resume with a fresh GPT

Say:

> Read `START_HERE.md`, `AGENTS.md`, `state/BOOTSTRAP_STATE.md`, and `state/CURRENT_STATE.md` in my private repository. Tell me what is established, what remains uncertain, and the smallest useful next step. Do not restart onboarding or change anything until you understand the current stage.

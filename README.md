...
English version 0.5 is available for initial use and participant testing. It adds operational evidence stages, handoff and automation verification, minimal consequential intake, selective system review, stale-write protection, and verification of the actual published dashboard. The Simplified Chinese edition is aligned with English version 0.5; its source revision and maintenance scope are recorded in [the translation notes](zh-CN/TRANSLATION.md). The new English and Chinese scenarios have not yet been run with a fresh GPT; improved operational fidelity remains to be demonstrated.
